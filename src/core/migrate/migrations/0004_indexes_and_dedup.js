 ...
 *
 * 1. Indexes on the timestamp columns that date-window filters scan
 *    (issues.created_at, metric_snapshots.computed_at, ai_verdicts.created_at)
 *    so snapshot reads stop doing full-table scans.
