...
export const reviewersPerPr = {
  ...
  compute(inputs, asOf) {
    ...
    for (const pr of mergedPrs) {
      const reviewerIds = reviewsByPr.get(pr.id) ?? new Set()
 ...
 */
export function giniCoefficient(counts) {
...
export const mergeWithoutReviewRate = {
