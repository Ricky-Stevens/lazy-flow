 ...
 */
export function isWindowClosed(day, watermarkAt, now, gracePeriodMs = DEFAULT_GRACE_PERIOD_MS) {
 ...
 */
export function buildCoverageFingerprint(ingestWatermarkVersion) {
 ...
 */
export async function computeSnapshotDay(opts, scopeType, scopeId, metricIds, day, computeFn) {
