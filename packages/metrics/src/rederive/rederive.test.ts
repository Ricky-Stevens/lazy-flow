...
import type { MetricResult, MetricScope, MetricSnapshot } from '@lazy-flow/core'
...
function makeComputeFn(value: number = 42): ComputeDayFn {
  return async (
...
describe('guardMixedVersionSeries', () => {
  ...
  it('throws and includes both versions in the error', () => {
    ...
    try {
      ...
      const err = e as MixedEngineVersionError
